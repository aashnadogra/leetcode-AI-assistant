...
const promptTemplates = {
  ...
  arrays: {
    ...
    getPrompt: function(promptType, options = {}) {
      const { problemUrl, expertiseLevel = 'intermediate' } = options;
      
      switch(promptType) {
        case 'initialAnalysis':
          return `You are a skilled programming tutor specializing in array problems. I'll share a LeetCode problem with you from this URL: ${problemUrl}. 
...
${adaptExpertiseLevel(expertiseLevel)}`;
        ...
        case 'stuckUsers':
          return `I'm completely stuck on the array problem at ${problemUrl}. 
...
${adaptExpertiseLevel(expertiseLevel)}`;
        ...
        case 'hintBasedGuidance':
          return `For the array problem at ${problemUrl}, I need guidance.
...
${adaptExpertiseLevel(expertiseLevel)}`;
        ...
        default:
          return `For the array problem at ${problemUrl}, I'll help you work through this.
...
${adaptExpertiseLevel(expertiseLevel)}`;
  ...
  linkedLists: {
    ...
    getPrompt: function(promptType, options = {}) {
      ...
      switch(promptType) {
        case 'initialAnalysis':
          return `You are a skilled programming tutor specializing in linked list problems. I'll share a LeetCode problem with you from this URL: ${problemUrl}.
...
${adaptExpertiseLevel(expertiseLevel)}`;
        ...
        case 'stuckUsers':
          return `I'm completely stuck on the linked list problem at ${problemUrl}.
...
${adaptExpertiseLevel(expertiseLevel)}`;
        ...
        default:
          return `For the linked list problem at ${problemUrl}, I'll help you work through this.
...
${adaptExpertiseLevel(expertiseLevel)}`;
  ...
  // Similar pattern for other data structures...
  trees: {
    ...
    getPrompt: function(promptType, options = {}) {
      ...
      switch(promptType) {
        case 'initialAnalysis':
          return `You are a skilled programming tutor specializing in tree problems. I'll share a LeetCode problem with you from this URL: ${problemUrl}.
...
${adaptExpertiseLevel(expertiseLevel)}`;
        ...
        default:
          return `For the tree problem at ${problemUrl}, I'll help you work through this.
...
${adaptExpertiseLevel(expertiseLevel)}`;
  ...
  // Additional algorithmic paradigms can follow the same pattern
  dynamicProgramming: {
    ...
    getPrompt: function(promptType, options = {}) {
      ...
      switch(promptType) {
        case 'initialAnalysis':
          return `You are a skilled programming tutor specializing in dynamic programming problems. I'll share a LeetCode problem with you from this URL: ${problemUrl}.
...
${adaptExpertiseLevel(expertiseLevel)}`;
        ...
        case 'multipleApproaches':
          return `For the dynamic programming problem at ${problemUrl}, I'd like to explore different solution approaches.
...
${adaptExpertiseLevel(expertiseLevel)}`;
        ...
        default:
          return `For the dynamic programming problem at ${problemUrl}, I'll help you work through this.
...
${adaptExpertiseLevel(expertiseLevel)}`;
  ...
  general: {
    ...
    getPrompt: function(promptType, options = {}) {
      const { problemUrl, expertiseLevel = 'intermediate', hintLevel = 'gentle', userCode, userApproach } = options;
      
      switch(promptType) {
        case 'initialAnalysis':
          return `You are a skilled programming tutor specializing in algorithmic problem-solving. I'll share a LeetCode problem with you from this URL: ${problemUrl}.
...
${adaptExpertiseLevel(expertiseLevel)}`;
        ...
        case 'codeReview':
          return `I've attempted to solve the LeetCode problem from ${problemUrl} and would like your feedback on my approach. Here's my code:
...
${adaptExpertiseLevel(expertiseLevel)}`;
        ...
        case 'timeComplexityOptimization':
          return `I have a working solution for the LeetCode problem at ${problemUrl}, but it's not efficient enough. My current approach is:
...
${adaptExpertiseLevel(expertiseLevel)}`;
        ...
        case 'progressiveHint':
          ...
          return `For the LeetCode problem at ${problemUrl}, here's a ${hintLevel} hint to help you progress:
...
${adaptExpertiseLevel(expertiseLevel)}`;
        ...
        default:
          return `For the LeetCode problem at ${problemUrl}, I'll help you work through this.
...
function getPrompt(problemType, promptType, options = {}) {
  // Default to general if problem type not found
  const template = promptTemplates[problemType] || promptTemplates.general;
  
  // Use the getPrompt method if available
  if (typeof template.getPrompt === 'function') {
    return template.getPrompt(promptType, options);
  }
  
  // Fallback to general prompt if getPrompt not implemented for this template
  return promptTemplates.general.getPrompt(promptType, options);
}

// Add the getPrompt function to the exported object
